...
export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: "GLEE — Onchain Generative Art",
  description: "Generative. Onchain. Alive. Yours.",
  openGraph: { title: "GLEE — Onchain Generative Art", description: "Generative. Onchain. Alive. Yours.", url: SITE_URL, siteName: "GLEE" },
  twitter: { card: "summary_large_image", title: "GLEE — Onchain Generative Art", description: "Generative. Onchain. Alive. Yours." },
};
